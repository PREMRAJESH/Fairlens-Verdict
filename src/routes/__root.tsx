...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A multi-agent hiring panel that surfaces bias in real time. Built on Gemini 2.5 Flash + Google ADK." },
      { name: "author", content: "FairLens" },
      { property: "og:title", content: "FairLens — AI that checks its own blind spots" },
